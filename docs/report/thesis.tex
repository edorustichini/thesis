...
\lstdefinestyle{pythonElegant}{
    ...
    showstringspaces=false,           % non evidenziare spazi nelle stringhe
    tabsize=4,                        % tab = 4 spazi
    captionpos=b,                     % caption sotto il codice
    xleftmargin=10pt,                 % margine sinistro
    xrightmargin=10pt
}
